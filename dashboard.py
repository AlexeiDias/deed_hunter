...
default_file_path = "/Users/alexeidias/Desktop/deed_finder_project/dashb/deed_hunter/output.csv"
...
if fl is not None:
    filename = fl.name
    st.write(filename)
    df = pd.read_csv(fl, header=[0, 1], index_col=0)
else:
    df = pd.read_csv(default_file_path, header=[0, 1], index_col=0)
